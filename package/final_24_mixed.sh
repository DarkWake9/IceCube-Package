...
#SBATCH --job-name=t4s_24_mix           ## Name of the job
#SBATCH --output=t4s_24_mix.out    ## Output file
#SBATCH --error=t4s_24_mix.err     ## Error file
...
python3 task4s_JCAP_2024_comment.py -nc 48
