...
#SBATCH --job-name=t4w2_1e-90           ## Name of the job
#SBATCH --output=t4w2_1e-90.out    ## Output file
#SBATCH --error=t4w2_1e-90.err     ## Error file
...
python3 ./task42w.py -nc 48 -nb 500 -np 3389 -lp 1e-90
