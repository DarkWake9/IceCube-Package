...
#SBATCH --job-name=t4w_4           ## Name of the job
#SBATCH --output=t4w_4.out    ## Output file
#SBATCH --error=t4w_4.err     ## Error file
...
python3 ./task4s_pyformat_corrected_sig_term_sims.py -c 4 -nc 48 -nb 200 -np 30
