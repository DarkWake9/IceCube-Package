...
#SBATCH --job-name=t4w_6           ## Name of the job
#SBATCH --output=t4w_6.out    ## Output file
#SBATCH --error=t4w_6.err     ## Error file
...
python3 ./task4s_pyformat_corrected_sig_term_sims.py -c 6 -nc 48 -nb 200 -np 30
