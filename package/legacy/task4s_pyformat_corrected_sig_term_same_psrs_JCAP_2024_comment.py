######### ALL WEIGHTS WITH SAME #.OF PULSARS
...
for i in range(2):
        ...
        plt.tight_layout()
        plt.savefig(f'outputs/TS_vs_E2dfde_all_w_model_bins={len(enus)}_C_wmodel{i+2}_{cone_deg}_valid_dDM_s14.pdf')

print(f'\nTS_vs_E2dfde_all_w_model_bins={len(enus)}_C_wt_{cone_deg}_valid_dDM_s14.pdf\nDONE')
...
plt.tight_layout()
plt.savefig(f'outputs/UL_all_w_model_bins={len(enus)}_C_wmodel_all_{cone_deg}_valid_dDM_s14.pdf')
# plt.show()
print('done')